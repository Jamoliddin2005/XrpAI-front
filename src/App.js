      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/"
            element={
              isRegistered ? <Navigate to="/main-active" replace /> : <SignInRootPage />
            }
          />
          <Route
            path="/signup"
            element={
              isRegistered ? <Navigate to="/main-active" replace /> : <SignUpRootPage />
            }
          />
          <Route
            path="/main-not-active"
            element={
              isRegistered ? <Navigate to="/main-active" replace /> : <MainPage />
            }
          />
