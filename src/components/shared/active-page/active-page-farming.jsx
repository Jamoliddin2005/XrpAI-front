              ...
              >
                ...
                {open ? (
                  <div onClick={handleSecondButton}>
                   <Button className={'border-2 border-transparent transition-all duration-300 rounded-xl hover:border-2 hover:border-[#43AFFF] hover:text-white hover:bg-transparent'} title={'Get Hash'} />
                  </div>
                ) : (
                  <>
            ...
            <div className='bg-[#141414] max-w-[500px] w-full  p-5 border-radiusss'>
              ...
              <div className='flex items-center justify-between gap-2 text-start border-2  text-white border-[#2C2C2C] rounded-xl py-2.5 px-3.5 mt-4 mb-4'>
                ...
                >
                  ...
                  <p className="md:hidden block">{truncateText(copyText2, 20)}...</p>
                </div>
                {clipboard2 ? (
                  <h1>
                    <i
