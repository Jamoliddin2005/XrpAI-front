    ...
    const handleData = async () => {
      try {
        ...
        data.forEach(message => {
          ...
          // Agar message.content bilan wallets'dagi address mos kelsa, uni tanlamaslik kerak
          ...
          // Agar manzil wallets ichida mavjud bo'lsa, contentni saqlamaymiz
          if (!isContentMatch) {
            usedAddresses.add(message.address)
            setMessageContent(message.content) // Bu faqat oxirgi contentni oladi
          }
        })

        setMessages(data) // Xabarlarni state'ga saqlash
      } catch (error) {
