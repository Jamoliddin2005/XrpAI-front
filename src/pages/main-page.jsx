    ...
    <>
      <div className='flex'>
              ...
              <div className='border-top-bottom'>
                <ul>
                  {navbarData.map((nav,index) => {
                    return (
                      <div key={nav.index} className='flex gap-2 items-center mb-4 sidebar-text trial'>
                        <Link className='flex gap-2 items-center mb-4 sidebar-text  transition-all duration-300' to={'/main-active'}>
        ...
        <div className='w-full 2xl:ml-[320px]'>
          <div>
            <div  data-aos="fade-down" className='text-white flex items-center justify-between py-5 px-3 md:py-10 md:px-8'>
              <div  className='flex items-center gap-1'>
                <div
            ...
            <div className='lg:flex border-t  border-t-[#1A1A1A] w-full'>
              <div className=' w-full'>
                ...
                <div className=' border-t border-[#1A1A1A]'>
                  <div  data-aos="fade-up" className='w-full justify-between md:flex gap-16 py-4 px-3 md:py-9 md:px-8'>
              ...
              <div  data-aos="fade-right" className=' border-l border-l-[#1A1A1A] '>
                <HomePageRight />
              </div>
            </div>
          </div>
          <div className='w-full border-t border-t-[#1A1A1A] py-2 px-4 md:py-5 md:px-7 '>
            <div className='flex justify-between items-start'>
              <div className='flex gap-6 text-white'>
                <p className='underline-text cursor-pointer grotesk'>Terminal</p>
